...
export const cities = [
  ...
  { city_id: '12', city_name: 'Agam' },
  { city_id: '13', city_name: 'Alor' },
  { city_id: '14', city_name: 'Ambon' },
  { city_id: '15', city_name: 'Asahan' },
  { city_id: '16', city_name: 'Asmat' },
  { city_id: '17', city_name: 'Badung' },
  { city_id: '18', city_name: 'Balangan' },
  { city_id: '19', city_name: 'Balikpapan' },
  { city_id: '20', city_name: 'Banda Aceh' },
  { city_id: '21', city_name: 'Bandar Lampung' },
  { city_id: '22', city_name: 'Bandung Kabupaten' }, // Kabupaten
  { city_id: '23', city_name: 'Bandung Kota' }, // Kota
  { city_id: '24', city_name: 'Bandung Barat' },
  { city_id: '25', city_name: 'Banggai' },
  { city_id: '26', city_name: 'Banggai Kepulauan' },
  ...
  { city_id: '31', city_name: 'Bangkalan' },
  { city_id: '32', city_name: 'Bangli' },
  { city_id: '33', city_name: 'Banjar Kabupaten' }, // Kabupaten
  { city_id: '34', city_name: 'Banjar Kota' }, // Kota
  { city_id: '35', city_name: 'Banjarbaru' },
  { city_id: '36', city_name: 'Banjarmasin' },
  { city_id: '37', city_name: 'Banjarnegara' },
  { city_id: '38', city_name: 'Bantaeng' },
  { city_id: '39', city_name: 'Bantul' },
  { city_id: '40', city_name: 'Banyuasin' },
  { city_id: '41', city_name: 'Banyumas' },
  { city_id: '42', city_name: 'Banyuwangi' },
  { city_id: '43', city_name: 'Barito Kuala' },
  { city_id: '44', city_name: 'Barito Selatan' },
  { city_id: '45', city_name: 'Barito Timur' },
  { city_id: '46', city_name: 'Barito Utara' },
  { city_id: '47', city_name: 'Barru' },
  { city_id: '48', city_name: 'Batam' },
  { city_id: '49', city_name: 'Batang' },
  { city_id: '50', city_name: 'Batang Hari' },
  { city_id: '51', city_name: 'Batu' },
  { city_id: '52', city_name: 'Batu Bara' },
  { city_id: '53', city_name: 'Bau-Bau' },
  { city_id: '54', city_name: 'Bekasi Kabupaten' }, // Kabupaten
  { city_id: '55', city_name: 'Bekasi Kota' }, // Kota
  ...
  { city_id: '61', city_name: 'Bengkayang' },
  { city_id: '62', city_name: 'Bengkulu Kota' }, // Kota
  ...
  { city_id: '67', city_name: 'Biak Numfor' },
  { city_id: '68', city_name: 'Bima Kabupaten' }, // Kabupaten
  { city_id: '69', city_name: 'Bima Kota' }, // Kota
  { city_id: '70', city_name: 'Binjai' },
  { city_id: '71', city_name: 'Bintan' },
  { city_id: '72', city_name: 'Bireuen' },
  { city_id: '73', city_name: 'Bitung' },
  { city_id: '74', city_name: 'Blitar Kabupaten' }, // Kabupaten
  { city_id: '75', city_name: 'Blitar Kota' }, // Kota
  { city_id: '76', city_name: 'Blora' },
  { city_id: '77', city_name: 'Boalemo' },
  { city_id: '78', city_name: 'Bogor Kabupaten' }, // Kabupaten
  { city_id: '79', city_name: 'Bogor Kota' }, // Kota
  { city_id: '80', city_name: 'Bojonegoro' },
  { city_id: '81', city_name: 'Bolaang Mongondow (Bolmong)' },
  { city_id: '82', city_name: 'Bolaang Mongondow Selatan' },
  { city_id: '83', city_name: 'Bolaang Mongondow Timur' },
  { city_id: '84', city_name: 'Bolaang Mongondow Utara' },
  { city_id: '85', city_name: 'Bombana' },
  { city_id: '86', city_name: 'Bondowoso' },
  { city_id: '87', city_name: 'Bone' },
  { city_id: '88', city_name: 'Bone Bolango' },
  { city_id: '89', city_name: 'Bontang' },
  { city_id: '90', city_name: 'Boven Digoel' },
  { city_id: '91', city_name: 'Boyolali' },
  { city_id: '92', city_name: 'Brebes' },
  { city_id: '93', city_name: 'Bukittinggi' },
  { city_id: '94', city_name: 'Buleleng' },
  { city_id: '95', city_name: 'Bulukumba' },
  { city_id: '96', city_name: 'Bulungan (Bulongan)' },
  { city_id: '97', city_name: 'Bungo' },
  ...
  { city_id: '108', city_name: 'Cirebon Kabupaten' }, // Kabupaten
  { city_id: '109', city_name: 'Cirebon Kota' }, // Kota
  ...
  { city_id: '116', city_name: 'Dharmasraya' },
  ...
  { city_id: '129', city_name: 'Gorontalo Kabupaten' }, // Kabupaten
  { city_id: '130', city_name: 'Gorontalo Kota' }, // Kota
  { city_id: '131', city_name: 'Gorontalo Utara' },
  ...
  { city_id: '138', city_name: 'Halmahera Barat' },
  { city_id: '139', city_name: 'Halmahera Selatan' },
  { city_id: '140', city_name: 'Halmahera Tengah' },
  { city_id: '141', city_name: 'Halmahera Timur' },
  { city_id: '142', city_name: 'Halmahera Utara' },
  { city_id: '143', city_name: 'Hulu Sungai Selatan' },
  { city_id: '144', city_name: 'Hulu Sungai Tengah' },
  { city_id: '145', city_name: 'Hulu Sungai Utara' },
  ...
  { city_id: '156', city_name: 'Jambi' },
  { city_id: '157', city_name: 'Jayapura Kabupaten' }, // Kabupaten
  { city_id: '158', city_name: 'Jayapura Kota' }, // Kota
  ...
  { city_id: '168', city_name: 'Kapuas Hulu' },
  ...
  { city_id: '176', city_name: 'Kayong Utara' },
  { city_id: '177', city_name: 'Kebumen' },
  { city_id: '178', city_name: 'Kediri Kabupaten' }, // Kabupaten
  { city_id: '179', city_name: 'Kediri Kota' }, // Kota
  ...
  { city_id: '188', city_name: 'Kepulauan Sangihe' },
  { city_id: '189', city_name: 'Kepulauan Seribu' },
  { city_id: '190', city_name: 'Kepulauan Siau Tagulandang Biaro (Sitaro)' },
  { city_id: '191', city_name: 'Kepulauan Sula' },
  { city_id: '192', city_name: 'Kepulauan Talaud' },
  { city_id: '193', city_name: 'Kepulauan Yapen (Yapen Waropen)' },
  { city_id: '194', city_name: 'Kerinci' },
  { city_id: '195', city_name: 'Ketapang' },
  ...
  { city_id: '236', city_name: 'Lima Puluh Koto/Kota' },
  ...
  { city_id: '247', city_name: 'Madiun Kabupaten' }, // Kabupaten
  { city_id: '248', city_name: 'Madiun Kota' }, // Kota
  { city_id: '249', city_name: 'Magelang Kabupaten' }, // Kabupaten
  { city_id: '250', city_name: 'Magelang Kota' }, // Kota
  { city_id: '251', city_name: 'Magetan' },
  { city_id: '252', city_name: 'Majalengka' },
  { city_id: '253', city_name: 'Majene' },
  { city_id: '254', city_name: 'Makassar' },
  { city_id: '255', city_name: 'Malang Kabupaten' }, // Kabupaten
  { city_id: '256', city_name: 'Malang Kota' }, // Kota
  ...
  { city_id: '279', city_name: 'Melawi' },
  { city_id: '280', city_name: 'Merangin' },
  ...
  { city_id: '289', city_name: 'Mojokerto Kabupaten' }, // Kabupaten
  { city_id: '290', city_name: 'Mojokerto Kota' }, // Kota
  { city_id: '291', city_name: 'Morowali' },
  { city_id: '292', city_name: 'Muara Enim' },
  { city_id: '293', city_name: 'Muaro Jambi' },
  ...
  { city_id: '321', city_name: 'Padang Panjang' },
  { city_id: '322', city_name: 'Padang Pariaman' },
  ...
  { city_id: '342', city_name: 'Pasuruan Kabupaten' }, // Kabupaten
  { city_id: '343', city_name: 'Pasuruan Kota' }, // Kota
  ...
  { city_id: '348', city_name: 'Pekalongan Kabupaten' }, // Kabupaten
  { city_id: '349', city_name: 'Pekalongan Kota' }, // Kota
  ...
  { city_id: '364', city_name: 'Pontianak Kabupaten' }, // Kabupaten
  { city_id: '365', city_name: 'Pontianak Kota' }, // Kota
  { city_id: '366', city_name: 'Poso' },
  { city_id: '367', city_name: 'Prabumulih' },
  { city_id: '368', city_name: 'Pringsewu' },
  { city_id: '369', city_name: 'Probolinggo Kabupaten' }, // Kabupaten
  { city_id: '370', city_name: 'Probolinggo Kota' }, // Kota
  { city_id: '371', city_name: 'Pulang Pisau' },
  { city_id: '372', city_name: 'Pulau Morotai' },
  ...
  { city_id: '393', city_name: 'Sarolangun' },
  ...
  { city_id: '398', city_name: 'Semarang Kabupaten' }, // Kabupaten
  { city_id: '399', city_name: 'Semarang Kota' }, // Kota
  { city_id: '400', city_name: 'Seram Bagian Barat' },
  { city_id: '401', city_name: 'Seram Bagian Timur' },
  { city_id: '402', city_name: 'Serang Kabupaten' }, // Kabupaten
  { city_id: '403', city_name: 'Serang Kota' }, // Kota
  ...
  { city_id: '420', city_name: 'Solok Kabupaten' }, // Kabupaten
  { city_id: '421', city_name: 'Solok Kota' }, // Kota
  { city_id: '422', city_name: 'Solok Selatan' },
  { city_id: '423', city_name: 'Soppeng' },
  { city_id: '424', city_name: 'Sorong Kabupaten' }, // Kabupaten
  { city_id: '425', city_name: 'Sorong Kota' }, // Kota
  ...
  { city_id: '430', city_name: 'Sukabumi Kabupaten' }, // Kabupaten
  { city_id: '431', city_name: 'Sukabumi Kota' }, // Kota
  ...
  { city_id: '452', city_name: 'Tanah Bumbu' },
  { city_id: '453', city_name: 'Tanah Datar' },
  { city_id: '454', city_name: 'Tanah Laut' },
  { city_id: '455', city_name: 'Tangerang Kabupaten' }, // Kabupaten
  { city_id: '456', city_name: 'Tangerang Kota' }, // Kota
  { city_id: '457', city_name: 'Tangerang Selatan' },
  { city_id: '458', city_name: 'Tanggamus' },
  { city_id: '459', city_name: 'Tanjung Balai' },
  { city_id: '460', city_name: 'Tanjung Jabung Barat' },
  { city_id: '461', city_name: 'Tanjung Jabung Timur' },
  ...
  { city_id: '466', city_name: 'Tapin' },
  { city_id: '467', city_name: 'Tarakan' },
  { city_id: '468', city_name: 'Tasikmalaya Kabupaten' }, // Kabupaten
  { city_id: '469', city_name: 'Tasikmalaya Kota' }, // Kota
  { city_id: '470', city_name: 'Tebing Tinggi' },
  { city_id: '471', city_name: 'Tebo' },
  { city_id: '472', city_name: 'Tegal Kabupaten' }, // Kabupaten
  { city_id: '473', city_name: 'Tegal Kota' }, // Kota
