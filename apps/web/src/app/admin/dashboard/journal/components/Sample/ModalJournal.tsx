...
// const ModalJournal: React.FC<JournalModalProps> = ({
//   journals,
//   isOpen,
//   onClose,
// }) => {
...
//   return (
//     <div className="fixed inset-0 bg-gray-600 items-center bg-opacity-50 overflow-y-auto h-full w-full z-30 flex justify-center">
